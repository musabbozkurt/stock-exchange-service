...
public class UserControllerIntegrationTests extends BaseUnitTest {
    ...
    void testCreateUser_ShouldFail_WhenPhoneNumberOrEmailIsAlreadyExists() {
        ...
        Assertions.assertEquals(StockExchangeServiceErrorCode.UNEXPECTED_ERROR, exception.getErrorCode());
    }
    ...
    void testGetUserById_ShouldFail_WhenUserIsNotFound() {
        ...
        Assertions.assertNotNull(exception);
        Assertions.assertEquals(StockExchangeServiceErrorCode.USER_NOT_FOUND, exception.getErrorCode());
    }
